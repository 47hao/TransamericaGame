...
public class RailFactory {
    ...
    final static Position[] leftDiagonalDoubleRails = { new Position(1, 2), new Position(2, 0), new Position(3, 1),
            new Position(2, 4), new Position(3, 4), new Position(3, 6), new Position(4, 8), new Position(5, 4)

    };
    final static Position[] rightDiagonalDoubleRails = { new Position(0, 0), new Position(8, 6)

    };
    final static Position[] rightDoubleRails = { new Position(4, 4), new Position(10, 10), new Position(8, 7)
