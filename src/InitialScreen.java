		...
		class ConfirmButtonListener implements ActionListener {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null, "Enter a valid number of games", "Error",
							JOptionPane.ERROR_MESSAGE, null);
					return;
				}
				if (!fastButton.isSelected() && !slowButton.isSelected()) {
					JOptionPane.showMessageDialog(null, "Choose a game speed", "Error", JOptionPane.ERROR_MESSAGE,
							null);
					return;
				}
